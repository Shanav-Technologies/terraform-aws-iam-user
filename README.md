...
| <a name="input_managedby"></a> [managedby](#input\_managedby) | ManagedBy, eg 'shanav-tech' | `string` | `"hello@shanav-tech.com"` | no |
...
| <a name="input_repository"></a> [repository](#input\_repository) | Terraform current module repo | `string` | `"https://github.com/shanav-tech/terraform-aws-iam-user"` | no |
